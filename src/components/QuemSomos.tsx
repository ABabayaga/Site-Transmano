...
export default function QuemSomos() {
  return (
    ...
    >
      <div className="mx-auto grid max-w-[1440px] grid-cols-[1fr_1.05fr] items-center gap-16 px-8 py-24 max-[1080px]:grid-cols-1 max-[1080px]:gap-10 max-[860px]:px-5 max-[860px]:py-14">
        <div className="relative overflow-hidden rounded-3xl">
          <img
            src="https://source.unsplash.com/800x900/?truck,mountain,road"
